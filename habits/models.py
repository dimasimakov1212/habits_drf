...
class Prize(models.Model):
    ...
    def __str__(self):
        return f'{self.prize_name}'  # Строковое отображение объекта

    class Meta:
        verbose_name = 'награда'  # Настройка для наименования одного объекта
        verbose_name_plural = 'награды'  # Настройка для наименования набора объектов
        ordering = ('prize_name',)  # сортировка
...
class Habit(models.Model):
    ...
    def __str__(self):
        return f'{self.habit_user} - {self.habit_name}'  # Строковое отображение объекта
    ...
    class Meta:
        ...
        ordering = ('habit_name',)  # сортировка
